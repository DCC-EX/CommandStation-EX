...
enum TRACK_MODE : byte {
  ...
  // Short names are the public vocabulary shared with DCCEX track commands.
  TRACK_MODE_MAINX = TRACK_MODE_MAIN_INV,
  TRACK_MODE_MAINA = TRACK_MODE_MAIN_AUTO,
  TRACK_MODE_BOOSTX = TRACK_MODE_BOOST_INV,
  TRACK_MODE_BOOSTA = TRACK_MODE_BOOST_AUTO,
